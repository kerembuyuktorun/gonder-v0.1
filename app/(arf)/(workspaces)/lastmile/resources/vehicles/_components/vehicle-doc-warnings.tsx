...
import { formatDocWarningText } from '../_lib/query-vehicles'
import type { VehicleDocWarning } from '../_types/vehicle'

type Props = {
  warnings: VehicleDocWarning[]
...
function WarningBody({ warnings }: { warnings: VehicleDocWarning[] }) {
  return (
...
export function VehicleDocWarnings({ warnings, variant = 'icon' }: Props) {
