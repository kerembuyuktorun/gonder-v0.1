...
const MOVEMENT_ACTION_LABEL_TR: Record<string, string> = {
  ...
  CANCEL_REQUESTED: 'İptal talebi oluşturuldu',
  CANCEL_REQUEST_APPROVED: 'İptal talebi onaylandı',
  CANCEL_REQUEST_REJECTED: 'İptal talebi reddedildi',
  ...
  ROUTE_HANDOVER: 'Transfer zimmeti',
  DELIVERY_DEFERRED: 'Ertesi güne devredildi',
  RETURN_CREATED: 'İade siparişi oluşturuldu',
