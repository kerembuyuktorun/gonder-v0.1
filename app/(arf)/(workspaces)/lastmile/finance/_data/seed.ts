...
export function buildSeedPriceLists(): PriceList[] {
  return [
    ...
    },
    {
      id: 'pl_pkg_km',
      code: 'PKT-KM',
      name: 'Paket Başı Km Tarifesi',
      description:
        'Paket kataloğu birim fiyatları × adet; mesafe km. Bant kuralları toplam paket sayısına göre eşleşir.',
      isDefault: false,
      status: 'active',
      currency: 'TRY',
      ...
      rules: [
        {
          id: 'rule_pkg_1_3',
          priceListId: 'pl_pkg_km',
          name: '1–3 paket · katalog + km',
          priority: 100,
          status: 'active',
          pricingMode: 'base_plus_km',
          desiPricing: 'dynamic',
        ...
        },
        {
          id: 'rule_pkg_4_10',
          priceListId: 'pl_pkg_km',
          name: '4–10 paket · katalog + km (indirimli)',
          priority: 90,
          status: 'active',
          pricingMode: 'base_plus_km',
          desiPricing: 'dynamic',
