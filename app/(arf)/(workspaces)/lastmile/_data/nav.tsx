...
export const createLastmileHeaderSearchCommands: SearchCommandFactory = (push) => [
  ...
  {
    id: 'go-finance-customers',
    label: 'Finans Müşteriler',
    group: 'Finans & Muhasebe',
    keywords: ['finans', 'müşteri', 'cari', 'bakiye', 'tahsilat'],
    onSelect: () => push(R.finance.customers.list),
  },
  {
    id: 'go-finance-suppliers',
    label: 'Finans Tedarikçiler',
    group: 'Finans & Muhasebe',
    keywords: ['finans', 'tedarikçi', 'kurye', 'cari', 'ödenecek'],
    onSelect: () => push(R.finance.suppliers.list),
  },
  {
    id: 'go-payouts',
    label: 'Hakedişler',
    group: 'Finans & Muhasebe',
    keywords: ['hakediş', 'kurye', 'ödeme', 'sözleşme'],
    onSelect: () => push(R.finance.payouts.list),
  },
  {
    id: 'go-price-lists',
    label: 'Müşteri Fiyat Listeleri',
    group: 'Fiyatlandırma',
    keywords: ['fiyat', 'liste', 'tarife', 'ücretlendirme'],
    onSelect: () => push(R.settings.pricing.priceLists.list),
  },
  {
    id: 'go-price-zones',
    ...
    onSelect: () => push(R.settings.pricing.zones.list),
  },
  {
    id: 'go-courier-cost-lists',
    label: 'Kurye Ücret Listeleri',
    group: 'Fiyatlandırma',
    keywords: ['kurye', 'ücret', 'maliyet', 'maaş', 'prim', 'tarife'],
    onSelect: () => push(R.settings.pricing.courierCostLists.list),
  },
]
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'İptal Talepleri', url: R.orders.cancelRequests, icon: Ban },
        ],
      },
      {
        title: 'Planlama',
      ...
      },
      {
        ...
        url: R.finance.customers.list,
        icon: Wallet,
        items: [
          { title: 'Müşteriler', url: R.finance.customers.list, icon: Users },
          { title: 'Tedarikçiler', url: R.finance.suppliers.list, icon: Building2 },
          { title: 'Hakedişler', url: R.finance.payouts.list, icon: Handshake },
          {
            title: 'Kurye Bakiyeleri',
            url: R.finance.courierBalances.list,
            icon: Banknote,
          },
          { title: 'Faturalar', url: R.finance.invoices.list, icon: FileText },
          {
            title: 'Faturalanmamış Siparişler',
            url: R.finance.uninvoicedOrders.list,
            icon: ClipboardList,
          },
          { title: 'Giderler', url: R.finance.expenses.list, icon: Receipt },
        ],
      },
      {
        title: 'Fiyatlandırma',
        url: R.settings.pricing.priceLists.list,
        icon: Tags,
        items: [
          {
            title: 'Müşteri Fiyat Listeleri',
            url: R.settings.pricing.priceLists.list,
            icon: Tags,
          },
          {
            title: 'Fiyat Bölgeleri',
            url: R.settings.pricing.zones.list,
            icon: MapPinned,
          },
          {
            title: 'Kurye Ücret Listeleri',
            url: R.settings.pricing.courierCostLists.list,
            icon: Bike,
          },
        ],
      },
