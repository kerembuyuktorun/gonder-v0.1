      ...
      <DialogContent className='overflow-hidden p-0 sm:max-w-3xl'>
        <div className='border-b bg-linear-to-br from-lime-200/80 via-background to-background px-6 py-5'>
          <DialogHeader className='text-left'>
            <div className='mb-2 flex flex-wrap items-center gap-2'>
              ...
              <Badge variant='outline'>Lastmile V1.0</Badge>
            </div>
            <DialogTitle className='text-2xl font-semibold tracking-tight'>
              Yardım & Destek
            </DialogTitle>
            <DialogDescription className='max-w-2xl text-sm'>
              Dağıtım, rota ve kurye operasyonlarıyla ilgili destek taleplerini buradan başlatabilirsiniz.
        ...
        <div className='space-y-6 px-6 py-5'>
          <section className='grid gap-3 md:grid-cols-3'>
            <a
              href='mailto:destek@kargosistemi.com?subject=ARF%20Lastmile%20Destek%20Talebi'
            ...
            >
              ...
              <p className='mt-1 text-xs text-muted-foreground'>
                Destek ekibine ekran görüntüsü ve sipariş kodu ekleyerek detaylı talep açın.
              </p>
            </a>
            ...
            >
              ...
              <p className='mt-1 text-xs text-muted-foreground'>
                Kritik dağıtım sorunlarında canlı operasyon hattı ile hızlıca iletişime geçin.
              </p>
            </a>
            ...
            <button
              type='button'
              onClick={() => {
                router.push(ARF_ROUTES.lastmile.support)
              }}
              className='group rounded-xl border border-border bg-card p-4 text-left transition-colors hover:border-lime-300 hover:bg-lime-50/60'
            >
            ...
            <div className='rounded-xl border border-border bg-muted/20 p-4'>
              ...
              <div className='space-y-3 text-xs text-muted-foreground'>
                ...
                <div className='rounded-lg border border-border/70 bg-background px-3 py-2'>
                  ...
                  <p>Talep açarken sipariş, rota ve kurye kodlarını birlikte paylaşın.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <div className='flex flex-wrap justify-end gap-2'>
            ...
            >
              <a href='mailto:destek@kargosistemi.com?subject=ARF%20Lastmile%20Destek%20Talebi'>Talep Oluştur</a>
            </Button>
          </div>
        </div>
      </DialogContent>
