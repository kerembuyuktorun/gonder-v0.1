...
import type { IncomingEInvoiceSummary } from "../_types/incoming-e-invoice"
...
export function IncomingEInvoicesSummaryCards({ summary }: Props) {
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <SummaryCard
        ...
        value={formatMoney(summary.acceptedAmount)}
      ...
      <SummaryCard
        ...
        iconClassName={summary.pendingCount > 0 ? "border-amber-500/20 bg-amber-500/10 text-amber-600" : undefined}
        valueClass={summary.pendingCount > 0 ? "text-amber-700" : undefined}
      />
      <SummaryCard
        label="Toplam Gelen"
        value={`${summary.totalCount} Fatura`}
