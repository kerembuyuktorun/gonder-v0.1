...
export function MatchedSenderBranchCard({ result }: Props) {
  return (
    <Card className="rounded-2xl border-slate-200 bg-white shadow-sm">
      <CardHeader className="pb-3">
        <CardTitle className="text-base text-slate-900">Gönderici Şube</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3 text-sm">
        ...
        {result.branch ? (
          ...
          <p className="text-slate-600">Gönderici adres için eşleşen şube bulunamadı.</p>
        )}
