...
import type { DashboardKpi } from "../_types/dashboard"

const iconMap: Record<string, typeof Package> = {
  "Toplam Kargo": Package,
  "Teslim Edilen": CheckCircle2,
  "Aktif Müşteriler": Users,
  "Aktif Seferler": Truck,
  "Günlük Ciro": TrendingUp,
  "Tahsilat Oranı": Wallet,
}
...
export function DashboardKpiCards({ kpiCards }: Props) {
  return (
