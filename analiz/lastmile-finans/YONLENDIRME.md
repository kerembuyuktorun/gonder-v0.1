...
Tarz: [`FE_GUIDE.md`](./FE_GUIDE.md) ile aynı — kısa tablolar + süreç anlatımı. Finans bölümü o dosyanın içeriğini de kapsar.

**Durum:** Finans BFF canlı (`/api/lastmile/*`); ops fallback’leri hâlâ demo/mock olabilir.  
Finans backend notları: [`BACKEND_PROMPT.md`](./BACKEND_PROMPT.md) · API: [`FINANCE_API.md`](./FINANCE_API.md) · İndeks: [`../README.md`](../README.md)
...
Sidebar: **Finans & Muhasebe**. Aşağıdaki tablo [`FE_GUIDE.md`](./FE_GUIDE.md) içeriğinin güncel özetidir.
...
| [`FE_GUIDE.md`](./FE_GUIDE.md) | Finans odaklı kısa özet (içerik burada da var) |
| [`BACKEND_PROMPT.md`](./BACKEND_PROMPT.md) | Backend öncelikleri |
| [`FINANCE_API.md`](./FINANCE_API.md) | Canlı BFF API + sayfa bağlama |
| [`FINANCE_DEV.md`](./FINANCE_DEV.md) | Dev / deploy checklist |
